const PREFIX='geo-classroom-',CACHE=PREFIX+'v4.0';
const CORE=['./','./index.html','./style.css','./app.js','./teaching-ui.js','./template-ui.js','./template.css','./video-review.js','./video-review.css','./page-ink.js','./data/teaching.json','./manifest.webmanifest','./icon-192.png','./icon-512.png','./data/catalog.json','./data/resources.json','./data/audit.json'];
